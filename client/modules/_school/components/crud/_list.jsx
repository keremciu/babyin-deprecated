      ...
      <Table fullWidth>
        ...
        >
          <TableRow>
            ...
            <TableHeaderColumn><T label="form_capacity" /></TableHeaderColumn>
          ...
          {collection.map(record => (
            <TableRow>
              ...
              <TableRowColumn className="table--actions">
                <a href={`/schools/${record._id}`}><ViewIcon hoverColor="#8726F7" /></a>
                <a href={`/schools/${record._id}/edit`}><EditIcon hoverColor="#8726F7" /></a>
              </TableRowColumn>
            </TableRow>
          ))}
        </TableBody>
